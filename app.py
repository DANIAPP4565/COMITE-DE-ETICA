...
BUILD_ID = "CEI-NEXUS-FIX4-20260718"
...
try:
    ...
    st.error("CEI Nexus no pudo conectarse o validar la base PostgreSQL.")
    st.code(str(exc))
    st.info(
        "Revise DATABASE_URL y DATABASE_ADMIN_URL en Streamlit Secrets. "
        "Para la primera inicialización puede usar AUTO_MIGRATE='true'; "
        "después vuelva a AUTO_MIGRATE='false'."
    )
    st.stop()
